...
import * as live from "./live/billing"
import * as demo from "./demo/billing"

export type { BillingResult, BillingEstado, FeeUpdateResult } from "./live/billing"

const impl: typeof live = DEMO_MODE ? demo : live

export const {
  fetchBillingStatuses,
  upsertBillingStatuses,
